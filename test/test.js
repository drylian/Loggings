const fs = require("fs");
const { Loggings, Formatter, LoggingsDefault, Timer, Controller } = require("../dist/Loggings");
const { LoggingsColors } = require("../dist/Loggings/defaults");
const { Colors } = require("../dist/Loggings/Colors");
...
const FormatterExpect = {
    message_csl: '\x1B[34mTesting\x1B[0m \x1B[31m\x1B[1mFormatter\x1B[0m\x1B[0m\x1B[33mArguments\x1B[0m \x1B[34m1\x1B[0m \x1B[32m{"teste":"teste"}\x1B[0m',
    message_rgt: '"Testing" "Formatter""Arguments" 1 "{"teste":"teste"}"'
}
if (!FormatterTest === FormatterExpect) throw new Error("Formatter is invalid, the response obtained is different from what was expected")
